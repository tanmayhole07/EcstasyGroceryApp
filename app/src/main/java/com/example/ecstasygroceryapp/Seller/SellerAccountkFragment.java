 ...
 * Use the {@link SellerAccountkFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SellerAccountkFragment extends Fragment {
     ...
     * @return A new instance of fragment SellerAccountkFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SellerAccountkFragment newInstance(String param1, String param2) {
        SellerAccountkFragment fragment = new SellerAccountkFragment();
    ...
    private void showEditProfileDialog() {
        String options[] = {"Edit Profile Picture", "Edit Name", "Edit Shop Name", "Edit Phone", "Edit Delivery Fee", "Edit Store Address", "Change Password"};
        ...
        builder.setItems(options, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int which) {
                if (which == 0) {
                    ...
                    pd.setMessage("Updating Shop Name");
                    showShopNameDeliveryFeeDailog("shopName");
                } else if (which == 3) {
                    pd.setMessage("Updating Phone");
                    showNamePhoneUpdateDialog("phone");
                } else if (which == 4) {
                    pd.setMessage("Updating Delivery Fee");
                    showShopNameDeliveryFeeDailog("deliveryFee");
                } else if (which == 5) {
                    pd.setMessage("Updating Store Address ");
                    showEditStoreAddressDialog();
                } else if (which == 6) {
    ...
    private void showEditStoreAddressDialog() {
        ...
        editText.setHint("Enter Store Address");
    ...
    private void showShopNameDeliveryFeeDailog(final String key) {
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(getActivity());
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot ds : snapshot.getChildren()) {
                            ...
                            String storeAddress = "" + ds.child("address").getValue();
